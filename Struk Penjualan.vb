...
Public Class Struk_Penjualan
    ...
    Sub combo()
        adapter = New MySqlDataAdapter("select * from view_transaksi order by kode_transaksi desc limit 1", con)
        ds = New DataSet
        ds.Clear()
        adapter.Fill(ds, "view_transaksi")
        cmd = New MySqlCommand("select * from view_transaksi order by kode_transaksi desc limit 1", con)
